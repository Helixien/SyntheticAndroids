...
{
	public class JobGiver_GetRestAndroid : ThinkNode_JobGiver
	{
		...
		{
			JobGiver_GetRestAndroid obj = (JobGiver_GetRestAndroid)base.DeepCopy(resolve);
		...
		{
			Need_Energy rest = pawn.needs.TryGetNeed<Need_Energy>();
			if (rest == null)
			{
				return 0f;
			}
		...
		public override Job TryGiveJob(Pawn pawn)
		{
			...
			{
				return JobMaker.MakeJob(SADefOf.SA_AndroidLayDown, building_Bed);
			}
			return JobMaker.MakeJob(SADefOf.SA_AndroidLayDown, FindGroundSleepSpotFor(pawn));
		}
